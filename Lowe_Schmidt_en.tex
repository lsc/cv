...
Jarl Kulles Gata 6			& \textit{Phone:} +46 723 867 157\\
...
\begin{outerlist}
\item[]  Technical consulting in areas like infrastructure development, IT operations and release engineering. Member of the cross functional NaDO team consisting of systems administrators, system developers and project managers. 
\end{outerlist}
\blankline

\textbf{System Administrator} at \href{http://www.avanza.se}{\textbf{Avanza}}\hfill {April 2013 - Oktober 2013}
\begin{outerlist}
\item[] The platform group within Avanza is responsible for web and trade operations at Avanza. My focus is on the day to day and long term administration of the web platform running on Red Hat Linux servers with Gigaspaces technology at the application layer. As my interest in infrastructure automation and orchestration are strong I also try to take extra care of our Puppet and Mcollective instances, release strategies for our code, upgrade paths and providing feedback on manifest development to co-workers.
\end{outerlist}
\blankline
...
\section{Technology}
Excellent Linux skills, good networking skills; including load balancers and switches, extensive experience with configuration management tools especially Puppet but also Chef and Saltstack, decent scripting skills with a favour for Perl and Ruby, a strong interest in automation, software packaging and metrics gathering.
