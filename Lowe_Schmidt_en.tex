...
\begin{outerlist}
\item[] Designing and operating technical infrastructure that runs Qapital backend services, working daily with AWS, Linux, Terraform,
...
\item Designed and implemented a new 
\end{outerlist}
\blankline
...
\item[] DevOpsdays is a global conference organisation ran by volunteers, I planned and hosted the very first event in Stockholm, Sweden.
	Tasks included talk selection, sponsor communication and aquirement, marketing and more.
\end{outerlist}
\blankline
