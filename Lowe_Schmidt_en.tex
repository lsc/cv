...
\begin{outerlist}
\item[]  Technical consulting in areas like configuration management, agile operations and plain old systems administration. Member of the cross functional NaDO team consisting of systems administrators, developers and project managers.
\end{outerlist}
\blankline
