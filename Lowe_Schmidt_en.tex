...
\begin{outerlist}
\item[]As a Consultant for Init I have worked with customers in the media and broadcasting business, startups in the telecom sector and online gambling.
	...
	\item Custom Puppet module development to manage Gigaspaces, I also extracted the core to a (work in progress) open source version.
	\item Developed tools to fix subtitles and manifest files for the media archive at Viaplay.
...
\begin{outerlist}
\item[]Systems administrator and infrastructure design for the Web Operations team at Avanza. Our technical platform was based on
	RHEL/Solaris, the JVM, Gigaspaces, Oracle and MongoDB. We used an agile approach to operations, combining Scrum and Kanban.
