...
%
%
\textbf{Consultant} at \href{http://www.init.se}{\textbf{Init}}\hfill {Since November 2013}
\begin{outerlist}
...
\begin{outerlist}
\item[] Squace was a mobile app for Java based feature phones, tasks included system administration, office it support, minor sql
...
\begin{outerlist}	
\item[]System administration, both internal and as a consultant, for a small integration specialist consultancy.
	...
	\item Replaced the aging Windows 2000 AD server with a new one based on Debian, OpenLDAP and Samba, included planning, procurement and
		execution.
	\item Consulted at SVT as WebLogic Integration administrator.
	\item Consulted at Ledarna on their web platform, consisting of WebSphere Express, DB2 Express and Windows 2003 Server.
...
\section{Technology}
UNIX like operating systems (RHEL, Debian, Ubuntu, Gentoo, OpenBSD)

Configuration Management tools (Puppet, Chef, Saltstack)

Scripting (Shell, Perl, Ruby)

Computer Networking (TCP/IP, F5 BigIPs, Force10 Switches, Mikrotik switches)
...
Job Schedulers (Jenkins)

Application Servers (Glassfish, Tomcat, Gigaspaces, LAMP)
